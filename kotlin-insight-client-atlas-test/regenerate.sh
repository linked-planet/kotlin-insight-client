...
ARTIFACT_ID="kotlin-insight-client-atlas-test"
...
mvn archetype:generate -B -U \
    ...
    "-DartifactId=kotlin-insight-client-atlas-test" \
    "-Dpackage=com.linkedplanet.plugin.confluence.insightclient.test" \
    "-DnameHumanReadable=kotlin-insight-client-atlas-test" \
